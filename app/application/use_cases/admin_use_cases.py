...
def _require_admin(actor: User) -> None:
    if actor.role != UserRole.ADMIN:
        raise AuthorizationError("Only admin can access the administration panel")
...
class UpdateUserRole:
    ...
    def execute(self, actor: User, user_id: int, role: str) -> User:
        ...
        if (
            ...
            raise AuthorizationError("Cannot demote the last active admin")
...
class ToggleUserActive:
    ...
    def execute(self, actor: User, user_id: int) -> User:
        ...
        if (
            ...
            raise AuthorizationError("Cannot disable the last active admin")
